...
function runTests() {
  http
    .get('http://localhost:1337/?img=1', function (res) {
  ...
  http
    .get('http://localhost:1337/admin/users', function (res) {
  ...
  http
    .get('http://localhost:1337/admin/users?user=1', function (res) {
  ...
  http
    .get('http://localhost:1337/something-else', function (res) {
